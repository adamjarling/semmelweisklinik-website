...
export const ui = {
  en: {
    ...
    rooms: {
      ...
      detail_contact_prompt: 'Interested? Send us an email to:',
      ...
      pricing_soli_text: 'You have a good idea or want to try something out but can\'t afford the regular price?',
      pricing_soli_link_text: 'Then check out our Soli Program!',
      pricing_soli_url: 'https://docs.google.com/forms/d/e/1FAIpQLSfwT-94Ut3a5xMCgSuxydTm3DKNK2lw56Rr3dTjaivvb8UVwg/viewform',
  ...
  de: {
    ...
    rooms: {
      ...
      detail_contact_prompt: 'Interessiert? Schreib uns eine E-Mail an:',
      ...
      pricing_soli_text: 'Ihr habt eine gute Idee oder wollt mal was ausprobieren aber könnt die finanziellen Mittel für den regulären Preis nicht stemmen?',
      pricing_soli_link_text: 'Dann schaut euch das Soli-Programm an!',
      pricing_soli_url: 'https://docs.google.com/forms/d/e/1FAIpQLSd-TxPOndp7grXdaCE0CuieBx1Y6grYSp9QF7_EhAk8naVlYg/viewform',
